...
fun ListaTarefasScreen(
    ...
    // Guarda apenas o id da tarefa selecionada para exclusão (sobrevive à rotação de tela).
    var idTarefaParaExcluir by rememberSaveable { mutableStateOf<Int?>(null) }
    val tarefaParaExcluir = tarefas.find { it.id == idTarefaParaExcluir }
    ...
    ListaTarefasContent(
        ...
        onDeletar = { tarefa -> idTarefaParaExcluir = tarefa.id },
        tarefaParaExcluir = tarefaParaExcluir,
        onCancelarExclusao = { idTarefaParaExcluir = null },
...
fun ListaTarefasContent(
    ...
    if (tarefaParaExcluir != null) {
        ConfirmarExclusaoDialog(
            ...
            onConfirmar = { onConfirmarExclusao(tarefaParaExcluir) }
        )
    }
...
private fun ConfirmarExclusaoDialog(
    ...
    AlertDialog(
        ...
        text = {
            Text("A tarefa \"${tarefa.titulo}\" será excluída definitivamente. Deseja continuar?")
        },
        confirmButton = {
